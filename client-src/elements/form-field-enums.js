...
export const STAGE_TYPES_PROTOTYPE = new Set([
  STAGE_BLINK_PROTOTYPE,
  STAGE_FAST_PROTOTYPE,
  STAGE_PSA_IMPLEMENT_FIELDS,
]);
...
// Stages that display the "Experiment" section in the intent email template.
export const STAGE_TYPES_INTENT_EXPERIMENT = new Set([
  STAGE_BLINK_DEV_TRIAL,
  STAGE_FAST_DEV_TRIAL,
  STAGE_PSA_DEV_TRIAL,
  STAGE_DEP_DEV_TRIAL,
